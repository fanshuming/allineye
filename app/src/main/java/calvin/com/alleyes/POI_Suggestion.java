 ...
 * 演示poi搜索功能
 */
public class POI_Suggestion extends FragmentActivity implements
        OnGetPoiSearchResultListener, OnGetSuggestionResultListener,BDLocationListener {
...
*/
    ...
    public void onGetPoiResult(PoiResult result) {
        if (result == null || result.error == SearchResult.ERRORNO.RESULT_NOT_FOUND) {
            Toast.makeText(POI_Suggestion.this, "未找到结果", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_KEYWORD) {
            ...
            strInfo += "找到结果";
            Toast.makeText(POI_Suggestion.this, strInfo, Toast.LENGTH_LONG)
                    .show();
        }
    }
    ...
    public void onGetPoiDetailResult(PoiDetailResult result) {
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(POI_Suggestion.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(POI_Suggestion.this, result.getName() + ": " + result.getAddress(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onGetSuggestionResult(SuggestionResult res) {
        ...
        sugAdapter = new ArrayAdapter<String>(POI_Suggestion.this, android.R.layout.simple_dropdown_item_1line, suggest);
        keyWorldsView.setAdapter(sugAdapter);
    ...
    public void onReceiveLocation(BDLocation bdLocation) {
        //Receive Location
        //经纬度
        myBDLocationLati = bdLocation.getLatitude();
        myBDLocationLong = bdLocation.getLongitude();
        myCity = bdLocation.getCity();
        /*Toast.makeText(POI_Suggestion.this, myCity, Toast.LENGTH_SHORT)
                .show();*/
    }
